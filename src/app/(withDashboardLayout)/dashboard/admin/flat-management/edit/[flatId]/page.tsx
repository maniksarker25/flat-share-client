...
const EditFlat = () => {
  ...
  const handleUpdateFlat = async (values: FieldValues) => {
    setError("");
    ...
    try {
      ...
      if (res?.success) {
        ...
        router.push("/dashboard/admin/flat-management");
      } else {
      ...
      >
        ...
        >
          ...
          <Box textAlign={"center"}>
            {data?.data && (
              <FSForm onSubmit={handleUpdateFlat} defaultValues={data?.data}>
                <Grid container spacing={3} my={1}>
                  ...
                  >
                    ...
                    <label htmlFor="photo-upload">
                      ...
                      >
                        Upload Photo{" "}
                        <AddPhotoAlternateIcon sx={{ ml: "5px" }} />
                      </Button>
                    </label>
                    <input
